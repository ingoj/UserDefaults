...
abstract class UDFCheck extends ActiveRecord
{
    ...
    public const OP_CONTAINS = 3;
    public const OP_ENDS_WITH = 4;
    public const OP_NOT_EQUALS = 5;
    public const OP_NOT_STARTS_WITH = 6;
    public const OP_NOT_CONTAINS = 7;
    public const OP_NOT_ENDS_WITH = 8;
    public const OP_IS_EMPTY = 9;
    public const OP_NOT_IS_EMPTY = 10;
    public const OP_REG_EX = 11;
    ...
    abstract protected static function getDefinitionsOfCategory(): array;

    abstract protected function getFieldValue(ilObjUser $user): array;
}
